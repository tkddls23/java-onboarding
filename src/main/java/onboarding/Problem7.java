...
public class Problem7 {
    public static List<String> solution(String user, List<List<String>> friends, List<String> visitors) {
        Map<String, HashSet<String>> friendMap = createFriendMap(friends);
    ...
    private static Map<String,HashSet<String>> createFriendMap(List<List<String>> friends) {
    ...
    private static List<String> getRecommendedFriend(Map<String, Integer> friendScoreMap, Map<String, Integer> visitorScoreMap) {
        ...
        for(Map.Entry<String, Integer> entry : entryList){
            if(answer.size() < 5 && entry.getValue() != 0){
